...
let package = Package(
    ...
    dependencies: [
		...
		.package(url:"https://github.com/tannerdsilva/QuickLMDB.git", .upToNextMinor(from:"1.0.2")),
		...
		.package(url:"https://github.com/tannerdsilva/SwiftDate.git", .upToNextMinor(from:"6.1.0"))
    ],
    targets: [
