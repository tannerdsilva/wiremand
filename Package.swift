...
let package = Package(
    ...
    dependencies: [
		...
		.package(url:"https://github.com/tannerdsilva/bedrock.git", revision:"402fa70ae770068804180669671a6f1647f9d5e7"),
		.package(url:"https://github.com/tannerdsilva/rawdog.git", "12.0.0"..<"13.0.0"),
