...
class DaemonDB {
    ...
    init(directory:URL, running:Bool = true) throws {
		let makeEnv = try Environment(path:directory.appendingPathComponent("daemon-dbi").path, flags:[.noSubDir, .noSync, .noReadAhead, .writeMap], mapSize:75000000000, maxDBs:128)
